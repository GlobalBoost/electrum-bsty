...
;Interface Settings
  ...
  !define MUI_ICON "..\..\electrum_bsty\gui\icons\electrum.ico"
...
Section
  ...
  File /r "dist\electrum-bsty\*.*"
  File "..\..\electrum_bsty\gui\icons\electrum.ico"
  ...
  WriteRegStr HKCU "Software\Classes\globalboost" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
